...
contract NFTMarket is ReentrancyGuard {
    ...
    // People has to pay to put their NFT on this marketplace
    ...
    function createMarketItem(
        ...
        _itemIds.increment(); // add 1 to total number of items ever created
    ...
    function createMarketSale(
        ...
        // transfer ownership of the nft from the contract it selft to the buyer
    ...
    function fetchMarketItems() public view returns(MarketItem[] memory) {
        ...
        uint unsoldItemCount = _itemIds.current() - _itemsSold.current(); // total number of unsold items
        uint currentIndex = 0;
